---
title: JSON Mirror
description: Helps viewers to view JSON in a table format.
date: 2023-08-15T03:43:56.381Z
tags:
  - app-idea
  - json
---
...
I've seen many library that help converting JSON to CSV format. But most of the times, there are errors (missing properties, fields, etc...). It is understandable in case when there's many types of format that is contained in JSON "Like Array and objects". [JsonHero](jsonhero.io) is one inspiration to help viewers traverse the entries easily as well as pretty-format the value.
